use crate::{
    ...
    routes::{
        ...
        fulfill_order, get_all_orders, get_order_details, get_orders_for_admin, health_check,
        payment::checkout,
        products::{
        ...
        App::new()
            ...
            .wrap(
                Cors::default()
                    ...
                    .allowed_origin("https://ui-ovno40cdf-pharmacity-xyz.vercel.app")
            ...
            .route("/order", web::get().to(get_all_orders))
            .route(
                "/order/orderid/{order_id}",
                web::get().to(get_order_details),
            )
            .route("/order/admin", web::get().to(get_orders_for_admin))
